...
const MarqueeContent = () => {
  return (
    <div className="con-custom-marquee inline-block py-[2rem] relative whitespace-nowrap z-[90] text-[9vw] md:text-[7rem] font-[600]">
      ...
      <div className="dot-ball inline-block w-[1.2rem] h-[1.2rem] md:w-[2rem] md:h-[2rem] lg:w-[4rem] lg:h-[4rem] rounded-[50%] bg-pink-500 mb-1 md:mb-2 ml-[2rem] mr-[2rem]"></div>
      
      <h1 className="inline-block">MEDHACARE</h1>
      <div className="dot-ball inline-block w-[1.2rem] h-[1.2rem] md:w-[2rem] md:h-[2rem] lg:w-[4rem] lg:h-[4rem] rounded-[50%] bg-pink-500 mb-1 md:mb-2 ml-[2rem] mr-[2rem]"></div>
