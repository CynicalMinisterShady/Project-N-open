  ...
  const divisions = [
    {
      ...
      description:
        "Focused on predictive systems, machine learning models, and intelligent automation for next-gen solutions.",
    },
    {
      icon: <Zap className="w-8 h-8" />,
      title: "Health & Wellness Systems",
      description:
        "Dedicated to personalized health and mental wellness technologies that enhance quality of life.",
    },
    {
      icon: <Cpu className="w-8 h-8" />,
      title: "Software Architecture & Engineering",
      description:
        "Responsible for robust, scalable system design with modular architecture across all verticals.",
    },
    {
      icon: <Sparkles className="w-8 h-8" />,
      title: "Experience & Interface Design",
      description:
        "Ensures human centered, aesthetic digital experiences with intuitive interactions.",
    },
    {
      icon: <Zap className="w-8 h-8" />,
      title: "Cloud & Data Operations",
      description:
        "Manages secure, efficient cloud deployments and data pipelines for optimal performance.",
    },
    {
      icon: <Cpu className="w-8 h-8" />,
      title: "Management Support",
      description:
        "Enables smooth team workflows, task tracking, and HR processes through reliable management tools.",
    },
  ];
  ...
  const faqs = [
    {
      ...
      answer:
        "Labs is the innovation and R&D wing of NirveonX Omnicare, responsible for AI, engineering, and next gen digital ecosystems.",
    },
    {
      question: "Who can collaborate with Labs?",
      answer:
        "Internal teams, research partners, startups, and enterprise collaborators seeking AI, automation, or health tech solutions.",
    },
    {
      question: "Do you develop custom AI models?",
      answer:
        "Yes. Labs specializes in custom predictive systems, automation engines, and domain specific intelligence models.",
    },
    {
      question: "How do I request a project or collaboration?",
      answer:
        "Use the ‘Get Our Services’ section or contact NirveonX Omnicare for proposal submission.",
    },
  ];
    ...
    <div className="cursor-auto min-h-screen bg-black text-blue-100 overflow-hidden">
      ...
      <header
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
          scrollY > 50
            ? "bg-black/90 backdrop-blur-md border-b border-blue-900/50"
            : "bg-transparent"
        }`}
      >
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="hidden md:block">
            ...
            <Link href="/newService" className="cursor-grab">
            <button className="group relative px-3 py-2.5 rounded bg-blue-600 hover:bg-blue-500 transition-all duration-300 border border-blue-500/50 hover:border-blue-400">
          ...
          <div className="md:hidden bg-black/95 backdrop-blur-md border-t border-blue-900/50 p-6">
            ...
            >
              <button className="w-full px-6 py-3 rounded bg-blue-600 hover:bg-blue-500 transition-all duration-300 text-white font-medium">
                <Link href="/newService">Back</Link>
              </button>
            </a>
            <button className="w-full px-6 py-3 rounded bg-blue-600 hover:bg-blue-500 transition-all duration-300 text-white font-medium">
              Get Started
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-blue-300/70 text-lg">
              Cross domain collaboration for impactful innovation
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-8">
            {divisions.map((division, index) => (
              <div
                key={index}
                className="group relative p-8 rounded-sm bg-blue-950/30 border border-blue-800/30 hover:border-blue-600/50 hover:bg-blue-950/50 transition-all duration-500"
              >
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-8">
          <div className="p-10 rounded-sm bg-blue-950/30 border border-blue-800/30">
            ...
            <p className="text-lg text-blue-200/80 leading-relaxed">
              To build an integrated platform fostering innovation across
              health, AI, and smart living powered by ethics, sustainability,
              and data driven design.
            </p>
            <p className="text-lg text-blue-200/80 mt-4 leading-relaxed">
              We combine AI, engineering, and human centered design to enable
              rapid experimentation and scalable solutions.
            </p>
          </div>
      ...
      <section className="relative py-24 px-6">
        <div className="max-w-6xl mx-auto text-center mb-12">
          ...
          <p className="text-blue-300/70 text-lg">
            Our roadmap to transformative innovation
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
          {objectives.map((obj, index) => (
            <div
              key={index}
              className="group p-6 rounded-sm bg-blue-950/20 border border-blue-800/30 hover:border-blue-600/50 hover:bg-blue-950/40 transition-all"
            >
      ...
      <section
        id="faqs"
        className="py-24 bg-black border-t border-blue-900/40 px-6"
      >
        <div className="max-w-4xl mx-auto text-center mb-16">
          ...
          <p className="text-blue-300/80 mt-3">
            Everything you need to know about NirveonX Labs
          </p>
        </div>
        ...
        <div className="max-w-3xl mx-auto space-y-6">
          {faqs.map((faq, idx) => (
            <div
              key={idx}
              className="bg-blue-950/30 border border-blue-800/40 p-6 rounded-lg backdrop-blur-sm"
            >
      ...
      <section className="py-24 bg-gradient-to-r from-blue-900/30 to-blue-600/20 border-t border-blue-900/40 text-center">
        <div className="max-w-3xl mx-auto px-6">
          ...
          <p className="text-xl text-blue-200/80 mb-10">
            Partner with NirveonX Labs to build intelligent healthcare, AI
            automation, and next-gen software solutions.
          </p>
      ...
      <footer className="bg-black py-16 border-t border-blue-900/40">
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <p className="text-blue-400/70">
              Advanced R&D unit powering AI, health tech, and next-gen digital
              systems.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-blue-400/70">
              <li>
                <Link href="/HealthMateLanding" className="hover:text-blue-200">
                  HealthMate
                </Link>
              </li>
              <li>
                <Link href="/mindease" className="hover:text-blue-200">
                  MindEase
                </Link>
              </li>
              <li>
                <Link href="/goldencare" className="hover:text-blue-200">
                  GoldenCare
                </Link>
              </li>
              <li>
                <Link href="/amborapid" className="hover:text-blue-200">
                  AmboRapid
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-blue-900/40 mt-10 pt-8 text-center text-blue-500/60">
          © {new Date().getFullYear()} NirveonX Labs — Building the Future of
          Intelligence.
        </div>
      </footer>
